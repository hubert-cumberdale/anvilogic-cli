...
| 344 local operation contracts | Operator supplied | Opt-in `invoke` request/response validation | Exact matching, local references, status selection, malformed and adversarial inputs | OpenAPI 3.0.x required | No schemas bundled |
